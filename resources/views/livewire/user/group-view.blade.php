        ...
        <div class="lg:col-span-11 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button @click="showCreate = !showCreate" 
                    ...
                    <x-heroicon-o-plus x-show="!showCreate" class="w-5 h-5" />
                    <x-heroicon-o-x-mark x-show="showCreate" class="w-5 h-5" style="display: none;" />
                ...
                <div class="bg-white border border-indigo-100 rounded-3xl p-1 shadow-sm mb-8 relative overflow-hidden">
                    <div class="absolute top-4 right-4 z-10">
                        <button @click="showCreate = false"
                            class="p-2 bg-white/80 hover:bg-slate-100 rounded-full text-slate-400 transition">
