<div class="hidden lg:flex flex-col fixed left-0 top-16 h-[calc(100vh-4rem)] w-72 bg-white border-r border-slate-200 z-40">
    ...
    <nav class="flex-1 overflow-y-auto no-scrollbar p-3 space-y-1">
        ...
        <a wire:navigate href="{{ route('assignment') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
        ...
        <a wire:navigate href="{{ route('library') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
        ...
        <a wire:navigate href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-all duration-200 group">
        ...
        <a wire:navigate href="{{route('events')}}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
        ...
        <!-- SETTINGS -->
        <a wire:navigate href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-all duration-200">
