<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 mb-6">
    ...
    <form wire:submit.prevent="createPost">
        ...
        <div class="flex gap-4">
            ...
            <div class="flex-shrink-0">
                <img src="{{ auth()->user()->dp ?: 'https://ui-avatars.com/api/?name=' . auth()->user()->first_name . '+' . auth()->user()->last_name . '&background=6366f1&color=fff' }}"
                    alt="User" class="w-10 h-10 rounded-full object-cover border border-slate-100">
            </div>
        ...
        <!-- Image Preview Area -->
        <div wire:loading wire:target="image" class="mt-3 ml-14">
            <div
                class="flex items-center gap-2 text-indigo-600 font-medium bg-indigo-50 p-3 rounded-xl border border-indigo-100">
        ...
        @if ($image)
            <div wire:loading.remove wire:target="image" class="relative mt-3 ml-14 group">
