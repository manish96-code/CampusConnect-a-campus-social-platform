<div class="min-h-screen flex bg-white relative overflow-hidden">
    ...
    <div class="hidden lg:block relative w-0 flex-1 overflow-hidden bg-indigo-900">
        <img class="absolute inset-0 h-full w-full object-cover object-center opacity-40 mix-blend-overlay filter blur-[1px]"
             src="https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Campus grounds">
        ...
        <div class="relative z-10 flex flex-col justify-center h-full px-12 text-white">
            <div class="mb-6">
                <div class="h-16 w-16 flex items-center justify-center rounded-2xl bg-white/20 backdrop-blur-lg border border-white/30 text-white mb-6 shadow-inner">
                ...
                <p class="mt-4 text-lg text-indigo-100 max-w-md leading-relaxed">
                    Sign in to access your student portal, view grades, and manage your course schedule.
                </p>
            </div>
            <div class="absolute bottom-10 left-12 text-sm text-indigo-200 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                    <path fill-rule="evenodd" d="M9.661 2.237a.531.531 0 01.678 0 11.947 11.947 0 006.878 2.743c.484.114.823.542.823 1.043v4.572c0 3.573-2.213 6.839-5.504 8.32a.628.628 0 01-.513 0C5.153 17.462 2.94 14.196 2.94 10.623V6.023c0-.501.339-.929.823-1.043A11.947 11.947 0 009.661 2.237z" clip-rule="evenodd" />
                </svg>
    ...
    <div class="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-16 xl:px-24 bg-gray-50 lg:bg-white w-full lg:w-[600px]">
        <div class="mx-auto w-full max-w-md lg:max-w-lg space-y-8" x-data="{ showPassword: false }">

            <div class="text-center lg:text-left">
                <div class="lg:hidden mx-auto h-12 w-12 flex items-center justify-center rounded-xl bg-indigo-600 text-white mb-4 shadow-lg shadow-indigo-600/20">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
                    </svg>
                </div>
                <h2 class="text-3xl font-bold tracking-tight text-gray-900">Student Login</h2>
                <p class="mt-2 text-sm text-gray-600">
                    Please enter your credentials to continue.
                </p>
            </div>

            <form wire:submit.prevent="login" class="space-y-6 mt-8" novalidate>

                <div>
                    <label for="email" class="block text-sm font-semibold leading-6 text-gray-700">Email Address</label>
                ...
                <div>
                    ...
                    <div class="relative mt-1.5 rounded-md shadow-sm">
                        ...
                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-indigo-600 focus:outline-none transition-colors">
                            ...
                            <svg x-show="showPassword" class="h-5 w-5 hover:cursor-pointer" style="display: none;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-gray-700 cursor-pointer select-none">Remember me</label>
                    </div>

                    <div class="text-sm">
                        <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 hover:underline">Forgot password?</a>
                    </div>
                </div>
