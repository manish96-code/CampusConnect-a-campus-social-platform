<div class="min-h-screen flex bg-white relative overflow-hidden">
    ...
    <div
        class="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-16 xl:px-24 bg-gray-50 lg:bg-white w-full lg:w-[600px]">
        <div class="mx-auto w-full max-w-md lg:max-w-lg space-y-8" x-data="{ showPassword: false }">
            ...
            <form wire:submit.prevent="login" class="space-y-6 mt-8" novalidate>
                ...
                <div>
                    <label for="email" class="block text-sm font-semibold leading-6 text-gray-700">Email
                        Address</label>
                ...
                <div>
                    ...
                    <div class="relative mt-1.5 rounded-md shadow-sm">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            ...
                            <svg x-show="showPassword" class="h-5 w-5 hover:cursor-pointer" style="display: none;"
