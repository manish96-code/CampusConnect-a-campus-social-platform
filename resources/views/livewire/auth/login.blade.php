                ...
                <div>
                    ...
                    <div class="relative mt-1.5 rounded-md shadow-sm">
                        ...
                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-indigo-600 focus:outline-none transition-colors">
                            ...
                            <svg x-show="showPassword" class="h-5 w-5" style="display: none;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
